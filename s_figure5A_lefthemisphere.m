...
% Perform multiple linear regression analysis on FA along the left SLF I, by excluding the variance of the FA along the SLF I and II, and then plot the residual FA in each group as a bar plot. This script aims to reproduce the left panel of Figure 5A in a following article:
%
