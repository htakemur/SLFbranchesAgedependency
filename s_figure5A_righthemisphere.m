function s_figure5A_righthemisphere
...
l_slf1_residual = fa_plot(4,:) - predict_l_slf1;

% Divide Right SLF I residual into age group for plots, and calculate mean and standard error
